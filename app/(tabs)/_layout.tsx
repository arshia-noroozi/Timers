  ...
  return (
    <Tabs
      screenOptions={{
        ...
        // Increase tab bar height only on web
        tabBarStyle: isWeb
          ? {
    ...
    >
      {/* inside.tsx → name="index" since that's your default tab */}
      <Tabs.Screen
        name="index"
        options={{
          title: "داخل",
          tabBarIcon: ({ color }) => (
            // a "house" icon fits "inside"
            <Svg viewBox="64 64 896 896" width={16} height={16} fill={color}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "بیرون",
          tabBarIcon: ({ color }) => (
            <Svg width={16} height={16} viewBox="64 64 896 896">
              <Path
